...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Account", b =>
                {
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Card", b =>
                {
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Customer", b =>
                {
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Loan", b =>
                {
            ...
            modelBuilder.Entity("ServiceLibrary.Data.PermenentOrder", b =>
                {
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Transaction", b =>
                {
            ...
            modelBuilder.Entity("ServiceLibrary.Data.User", b =>
                {
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Card", b =>
                {
                    b.HasOne("ServiceLibrary.Data.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Disposition", b =>
                {
                    b.HasOne("ServiceLibrary.Data.Account", "Account")
                        .WithMany("Dispositions")
                        .HasForeignKey("AccountId")
                        .IsRequired()
                        .HasConstraintName("FK_Dispositions_Accounts");

                    b.HasOne("ServiceLibrary.Data.Customer", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("ServiceLibrary.Data.Transaction", b =>
                {
                    b.HasOne("ServiceLibrary.Data.Account", "AccountNavigation")
